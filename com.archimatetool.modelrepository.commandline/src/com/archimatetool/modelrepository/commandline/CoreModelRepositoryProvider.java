...
public class CoreModelRepositoryProvider extends AbstractCommandLineProvider {
    ...
    static final String OPTION_USERNAME = "modelrepository2.userName"; //$NON-NLS-1$
    static final String OPTION_PASSFILE = "modelrepository2.passFile"; //$NON-NLS-1$
    static final String OPTION_SSH_IDENTITY_FILE = "modelrepository2.identityFile"; //$NON-NLS-1$
    static final String OPTION_MODEL_FOLDER = "modelrepository2.modelFolder"; //$NON-NLS-1$
