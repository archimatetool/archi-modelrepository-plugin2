...
public class PushModelToRepositoryProvider extends AbstractModelRepositoryProvider {

    static final String PREFIX = "[PushModelToRepositoryProvider]"; //$NON-NLS-1$
    
    static final String OPTION_PUSH_MODEL = "modelrepository2.pushModel"; //$NON-NLS-1$
    
    public PushModelToRepositoryProvider() {
    }
    ...
    public void run(CommandLine commandLine) throws Exception {
        ...
        pushModel(commandLine);
    }
    
    private void pushModel(CommandLine commandLine) throws IOException, GitAPIException {
