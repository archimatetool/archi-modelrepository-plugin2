...
public class CloneModelProvider extends AbstractModelRepositoryProvider {
    ...
    static final String PREFIX = "[CloneModelProvider]"; //$NON-NLS-1$
    
    static final String OPTION_CLONE_MODEL = "modelrepository2.cloneModel"; //$NON-NLS-1$
    ...
    public void run(CommandLine commandLine) throws Exception {
        ...
        cloneModel(commandLine);
    }
    
    private void cloneModel(CommandLine commandLine) throws IOException, GitAPIException {
