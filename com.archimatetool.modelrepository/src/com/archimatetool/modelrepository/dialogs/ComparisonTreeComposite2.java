...
public class ComparisonTreeComposite2 extends Composite {
    ...
    public ComparisonTreeComposite2(Composite parent, int style, ModelComparison modelComparison) {
        super(parent, style);
        ...
        fTreeViewer.setComparator(new ViewerComparator() {
            ...
            public int compare(Viewer viewer, Object o1, Object o2) {
                ...
                if(o1 instanceof Change2 c1 && o2 instanceof Change2 c2) {
            ...
            public int category(Object element) {
                if(element instanceof Change2 change) {
    ...
    private class ContentProvider implements ITreeContentProvider {
        ...
        public Object[] getChildren(Object parentElement) {
            if(parentElement instanceof ModelComparison modelComparison) {
                if(changes == null) {
                    changes = modelComparison.getChangedObjects2().toArray();
                }
                return changes;
            }
            
            if(parentElement instanceof Change2 change) {
